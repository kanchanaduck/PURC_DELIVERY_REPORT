...
namespace api_purdelivery.Controllers
{
    ...
    public class input_filereasonController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("upload_file")]
        public async Task<IActionResult> upload_file([FromForm] req_upfile file)
        {
            try
            {
                if (file.fileDel_Do_name != "" && file.fileDel_Do_name != null && file.fileDel_Do_name != "undefined")
                {
                  await  upfile_Delivery_domesticAsync(file.fileDel_Do,file.fileDel_Do_name,file.update_by,file.subject); 
                }
                if (file.fileDel_Over_name != "" && file.fileDel_Over_name != null && file.fileDel_Over_name != "undefined")
                {
                  await  upfile_Delivery_OverseaAsync(file.fileDel_Over,file.fileDel_Over_name,file.update_by,file.subject); 
                }
                 if (file.filePO_name != "" && file.filePO_name != null && file.filePO_name != "undefined")
                {
                  await  upfile_po_issueAsync(file.filePO,file.filePO_name,file.update_by,file.subject); 
                }
                if (file.fileDelay_Do_name != "" && file.fileDelay_Do_name != null && file.fileDelay_Do_name != "undefined")
                {
                  await  upfile_Delay_DomesticAsync(file.fileDelay_Do,file.fileDelay_Do_name,file.update_by,file.subject); 
                }
                if (file.fileDelay_Over_name != "" && file.fileDelay_Over_name != null && file.fileDelay_Over_name != "undefined")
                {
                  await  upfile_Delay_overseaAsync(file.fileDelay_Over,file.fileDelay_Over_name,file.update_by,file.subject); 
                }
                if (file.fileDel_Evolio_name != "" && file.fileDel_Evolio_name != null && file.fileDel_Evolio_name != "undefined")
                {
                  await  upfile_Delivery_evolioAsync(file.fileDel_Evolio,file.fileDel_Evolio_name,file.update_by,file.subject); 
                }
                if (file.fileShortLT_name != "" && file.fileShortLT_name != null && file.fileShortLT_name != "undefined")
                {
                  await  upfile_short_LTAsync(file.fileShortLT,file.fileShortLT_name,file.update_by,file.subject); 
                }
                 if (file.filePU_name != "" && file.filePU_name != null && file.filePU_name != "undefined")
                {
                  await  upfile_pu_champAsync(file.filePU,file.filePU_name,file.update_by,file.subject); 
                }
                return Ok();
            }
            catch (Exception ex)
        ...
        [HttpPost("upfile_Delivery_domestic")]
        public async Task<string> upfile_Delivery_domesticAsync(IFormFile file,string name,string user,string sbj){
            
            string rootFolder = Directory.GetCurrentDirectory();
            string pathString2 = @"\API site\files\pur_delivery\Delivery_Domestic\";
            ...
            string fullpath = serverPath + file;
        ...
        [HttpPost("upfile_Delivery_oversea")]
        public async Task<string> upfile_Delivery_OverseaAsync(IFormFile file,string name,string user,string sbj){
             string rootFolder = Directory.GetCurrentDirectory();
             string pathString = @"\API site\files\pur_delivery\Delivery_Oversea\";
        ...
        [HttpPost("upfile_po_issue")]
        public async Task<string> upfile_po_issueAsync(IFormFile file,string name,string user,string sbj){
             string rootFolder = Directory.GetCurrentDirectory();
        ...
        [HttpPost("upfile_delay_domestic")]
        public async Task<string> upfile_Delay_DomesticAsync(IFormFile file,string name,string user,string sbj){
             string rootFolder = Directory.GetCurrentDirectory();
        ...
        [HttpPost("upfile_delay_oversea")]
        public async Task<string> upfile_Delay_overseaAsync(IFormFile file,string name,string user,string sbj){
             string rootFolder = Directory.GetCurrentDirectory();
        ...
        [HttpPost("upfile_Delivery_evolio")]
        public async Task<string> upfile_Delivery_evolioAsync(IFormFile file,string name,string user,string sbj){
             string rootFolder = Directory.GetCurrentDirectory();
            ...
            using (Stream stream = new FileStream(fullpath, FileMode.Create))
            {
                ...
                for (int i = 2; i <= rows; i++)
                {
                 T_Control_Evalio tbD = new T_Control_Evalio();
                    ...
                    tbD.today = Convert.ToString(worksheet.Cells[i, 5].Value);
        ...
        [HttpPost("upfile_short_LT")]
        public async Task<string> upfile_short_LTAsync(IFormFile file,string name,string user,string sbj){
             string rootFolder = Directory.GetCurrentDirectory();
        ...
        [HttpPost("upfile_pu_champ")]
        public async Task<string> upfile_pu_champAsync(IFormFile file,string name,string user,string sbj){
             string rootFolder = Directory.GetCurrentDirectory();
            ...
            using (Stream stream = new FileStream(fullpath, FileMode.Create))
            {
                ...
                for (int i = 2; i <= rows; i++)
                {
                    // long dateNum15 = long.Parse(worksheetab.Cells[i, 15].Value.ToString());
                    // DateTime result15 = DateTime.FromOADate(dateNum15);
                    // long dateNum16 = long.Parse(worksheetab.Cells[i, 16].Value.ToString());
                ...
                for (int i = 2; i <= rowsnew; i++)
                {
                    // // long dateNum15 = long.Parse(worksheetnew.Cells[i, 15].Value.ToString());
                    // double dateNum15 = double.Parse(worksheetnew.Cells[i, 15].Value.ToString());
                    //  DateTime result15 = DateTime.FromOADate(dateNum15);
                    // // long dateNum16 = long.Parse(worksheetnew.Cells[i, 16].Value.ToString());
                    // double dateNum16 = double.Parse(worksheetnew.Cells[i, 15].Value.ToString());
                    //  DateTime result16 = DateTime.FromOADate(dateNum16);
