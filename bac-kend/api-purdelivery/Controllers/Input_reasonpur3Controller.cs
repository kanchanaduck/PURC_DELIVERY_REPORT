...
namespace api_purdelivery.Controllers
{
    ...
    public class Input_reasonpur3Controller : ControllerBase
    {
        ...
        public Input_reasonpur3Controller(DataBaseContext context)
        {
            _context = context;
        }
       ...
       [HttpGet("get_subject_delay_shortLT")]
        ...
        [HttpPost("get_delay_domestic_row")]
        ...
        [HttpPost("get_delay_oversea_row")]
