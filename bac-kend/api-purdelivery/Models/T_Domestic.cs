...
namespace api_purdelivery
{
    public class T_Domestic
    {
        ...
        public string qt_und_insp_cuml { get; set; }
        public string qt_und_insp { get; set; }
        public string qt_acptc_bal { get; set; }
        public string qt_acptc_cuml { get; set; }
        ...
        public string cf_invent_dem { get; set; }
        ...
        public string cf_insp_type { get; set; }
        ...
        public string mk_import_item { get; set; }
        public string cf_transp_meth { get; set; }
        public string cm_coment { get; set; }
        public string cf_child_base { get; set; }
        public string no_po_legacy { get; set; }
