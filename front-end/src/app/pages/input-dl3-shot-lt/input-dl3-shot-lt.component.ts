...
@Component({
  selector: 'app-input-dl3-shot-lt',
  templateUrl: './input-dl3-shot-lt.component.html',
  styleUrls: ['./input-dl3-shot-lt.component.scss']
})
export class InputDl3ShotLTComponent implements OnInit {
