...
@Component({
  selector: 'app-check-otherdept',
  templateUrl: './check-otherdept.component.html',
  providers: [Service],
  styleUrls: ['./check-otherdept.component.scss']
})
export class CheckOtherdeptComponent implements OnInit {
